...
model = joblib.load("/home/aadi/Documents/sixth_sem/projects/web_tech_project/web2/pyrunner/gesture_knn_model.pkl")
...
while True:
    ...
    if results.multi_hand_landmarks:
        for handLms in results.multi_hand_landmarks:
            ...
            # if prediction in GESTURES and (prediction != last_gesture or current_time - last_sent_time > 4.0):
            if prediction in GESTURES and current_time - last_sent_time > 4.0:
                try:
